...
void Shutdown(void* parg)
{
    ...
    RenameThread("ultimatesecurecash-shutoff");
    ...
    if (fFirstThread)
    {
        ...
        printf("UltimateSecureCash exited\n\n");
        fExit = true;
#ifndef QT_GUI
...
{
    uiInterface.ThreadSafeMessageBox(str, _("UltimateSecureCash"), CClientUIInterface::OK | CClientUIInterface::MODAL);
    return false;
}

bool static InitWarning(const std::string &str)
{
    uiInterface.ThreadSafeMessageBox(str, _("UltimateSecureCash"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
    return true;
}
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: ultimatesecurecash.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: ultimatesecurecashd.pid)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("UltimateSecureCash version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
    ...
    ********************************************************* */
    ...
    if (filesystem::exists(GetDataDir() / strWalletFileName))
    {
        ...
        if (r == CDBEnv::RECOVER_OK)
        {
            ...
            uiInterface.ThreadSafeMessageBox(msg, _("UltimateSecureCash"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        };
