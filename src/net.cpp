...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("ultimatesecurecash-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("ultimatesecurecash-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("ultimatesecurecash-UPnP");
...
static const char *strDNSSeed[][2] = {
    {"45.55.52.85", "45.55.52.85"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("ultimatesecurecash-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("ultimatesecurecash-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("ultimatesecurecash-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("ultimatesecurecash-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. UltimateSecureCash is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("ultimatesecurecash-start");
